...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		event.tags.forEach((tag) => {
			tags += '<span class="fc-tag-box" style="background-color:' + tag + ';"></span>';
		});
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' +
					(this.isRTL ?
						titleHtml + ' ' + timeHtml +  tags: // put a natural space in between
						tags + timeHtml + ' ' + titleHtml   //
						) +
				'</div>' +
...
*/
							...
							button = $( // type="button" so that it doesn't submit a form
								'<a type="button" class="' + classes.join(' ') + '">' +
									innerHtml +
								'</a>'
								)
								.click(function(ev) {
