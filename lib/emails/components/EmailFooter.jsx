export default class EmailFooter extends React.Component {
  ...
  renderHTML(uid,footertype="newsletter") {
    const socialmedia = `<table  role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" bgcolor="#ffffff" border="0" align="center" width="100%" style="max-width: 680px; background: #1a3d6d;">
      <tr><td>
    ...
    const wraptop = `<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px; background: #1a3d6d;">
      <tr>
    ...
    const copyright = `<em>Copyright © 2018 RIT InterVarsity Christian Fellowship, All rights reserved.</em></br></br>`;
    const address = `<strong>Our mailing address is:</strong><br/>
    <address>
    RIT InterVarsity Christian Fellowship<br/>
    Attention: InterVarsity Christian Fellowship<br/>
    1 Lomb Memorial Drive<br/>
    Rochester, NY 14623<br/><br/>`;
    const unsubscribe = `You are receiving this&nbsp;newsletter because you signed up at one of our tables or events, or on our website.<br/><br/>
    ...
    switch (footertype) {
      case "newsletter":
        footercontent = socialmedia + wraptop + copyright + address + unsubscribe + wrapbottom;
        break;
      case "todoemail":
        footercontent = wraptop + copyright + wrapbottom;
        break;
      case "eventfollowup":
      case "prayergroup":
        footercontent = socialmedia + wraptop + copyright + address + wrapbottom;
        break;
      default:
        footercontent = socialmedia + wraptop + copyright + address + unsubscribe + wrapbottom;
    }
