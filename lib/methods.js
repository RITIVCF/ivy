...
Meteor.methods({
  ...
  // Job stuff
  createJobRequest(eid, uid, jobname, submitby, request){
    // arg: request - isRequest True/False
    Events.update(eid, {$addToSet: {"jobs": {uid:uid, job: jobname, status: "Pending", submittedby: submitby, isRequest: request}}});
