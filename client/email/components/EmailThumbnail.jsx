              ...
              <td align="center" valign="top" style="font-size:0; padding: 10px 0;">
                ...
                <div style="display:inline-block; margin: 0 -2px; max-width: 200px; min-width:160px; vertical-align:top; width:100%;" class="stack-column">
                  <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td dir="ltr" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding: 0 10px 10px 10px; text-align: left;" class="center-on-narrow">
                        <p style="margin: 0 0 10px 0;">&#128197; Date:</br>&#128337; Time:</br>&#127759; Location:</br>&#128231; Email:</br>(Yeah, just showing off)</p>
                      </td>
                    </tr>
                  </table>
                </div>
