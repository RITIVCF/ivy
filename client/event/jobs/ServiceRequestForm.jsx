...
export default class ServiceRequestForm extends TrackerReact(React.Component) {
	constructor(props) {
    super(props);
	...
	getRequests(){
		return this.props.event.jobs.filter((job)=>{
			...
			<div className="row">
				<div className="col s12 l6">
                  ...
                  ref="user"
						...
						<div className="row">
							<button className="btn-floating btn-large iv-blue right">
					...
					<ul className="collection">
						{this.getRequests().length > 0?this.getRequests().map((req,i)=>{
							return <SinglePosition key={i} job={req} eid={this.props.event._id} />
